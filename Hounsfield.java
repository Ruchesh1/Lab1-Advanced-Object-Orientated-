...
public class Hounsfield {
	...
	public Hounsfield(int value) {
		...
		if(value < MIN_VALUE || value > MAX_VALUE) {
			throw new IllegalArgumentException("Hounsfield unit is outside the range of Hounsfield unit");
		}else {
			this.value = value;
		}
	...
	private static void checkValue(int value) {
		...
		if(value < MIN_VALUE || value > MAX_VALUE) {
			throw new IllegalArgumentException("value is outside the range;");
		}
	}
	...
	public int set(int value) {
		...
		if(value < MIN_VALUE || value > MAX_VALUE) {
			throw new IllegalArgumentException("Value is outside the range of Hounsfield unit");
		}
